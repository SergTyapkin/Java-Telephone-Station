...
public abstract class TubeCallbackPOA extends org.omg.PortableServer.Servant
 implements TubeCallbackOperations, org.omg.CORBA.portable.InvokeHandler
{
 ...
 ! U U �!0 �  Q � message  U!   U X �! � fromNum */
       case 0:  // App/TubeCallback/sendSMS
       {
  ...
  /*   �! !S!!
 !  U    U X �! */
       case 1:  // App/TubeCallback/getNum
       {
         String $result = null;
         $result = this.getNum ();
         out = $rh.createReply();
